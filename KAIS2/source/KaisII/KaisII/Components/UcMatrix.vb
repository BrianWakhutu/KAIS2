...
Public Class UcMatrix
    ...
    Private Sub DisplayFieldControls()
        For Each f As Field In vMatrixField.ChildList
            ...
            ElseIf f.Fld_Type = Fieldtypes.FieldType.DateTime Then
                ...
                '-----ADD For Numbered value
            ElseIf f.Fld_Type = Fieldtypes.FieldType.numberValuedComboBox Then
                LayKaisControl(CreateNumberValuedComboBox(f))
    ...
    End Function
    Public Function CreateNumberValuedComboBox(ByVal field As Field) As UcNumberValuedComboBox
        Dim numberValuedComboBox As KaisII.UcNumberValuedComboBox = New KaisII.UcNumberValuedComboBox()
        numberValuedComboBox.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Left) _
            Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        numberValuedComboBox.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle
        numberValuedComboBox.Name = field.Fld_QNo & "numberValuedComboBox"
        numberValuedComboBox.TabIndex = vTabIndex
        numberValuedComboBox.Tag = field.Fld_QNo
        numberValuedComboBox.SetLabelText(field.Fld_QuestionEnglish)
        numberValuedComboBox.SetDataSource(field.fld_Lookups)
        numberValuedComboBox.Field = field
        AddHandler numberValuedComboBox.KeyPress, AddressOf ExtractSkip

        Return numberValuedComboBox
    End Function
